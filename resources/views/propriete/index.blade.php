...
<!-- Div écamotable au passage de la souris avec transition -->
<div x-data="{ open: false }" 
     @mouseenter="open = true" 
     @mouseleave="open = false" 
     class="bg-gray-700 p-5 mb-5 text-center transition-all duration-300"
     :class="{'h-10 overflow-hidden': !open, 'h-40': open}">
    <form x-show="open" x-transition:enter="transition ease-out duration-300"
          ...
          action="" method="get" class="flex justify-center gap-2">
